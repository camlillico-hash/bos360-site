...
<p className="inline-flex items-center rounded-full border border-blue-400/40 bg-blue-500/10 px-4 py-1 text-xs font-semibold uppercase tracking-widest text-blue-200">
BOS360 Business Coaching
</p>

<h1 className="mt-6 max-w-5xl text-4xl font-bold leading-tight tracking-tight md:text-6xl">
I help B2B SaaS leaders scale from{" "}
<span className="bg-gradient-to-r from-cyan-300 to-blue-400 bg-clip-text text-transparent">
$2M to $50M
</span>{" "}
with clarity, execution, and accountability.
</h1>
...
<h3 className="text-2xl font-semibold">Ready to Scale with More Clarity?</h3>
