                ...
                <div className="max-w-3xl">
                  <div className="flex items-center gap-4">
                    <img
                      src="/cam-headshot-circle.png"
                      alt="Cam Lillico"
                      className="h-16 w-16 rounded-full border border-slate-200 object-cover shadow-sm sm:h-20 sm:w-20"
                      loading="lazy"
                    />
                    <div>
                  ...
                  <h3 className="mt-5 text-2xl font-semibold tracking-tight text-slate-900">An experienced operator with a practical coaching style</h3>
          ...
          <div className="mt-6 grid grid-cols-1 gap-6">
            <div className="md:col-span-7">
              <p className="mb-4 max-w-3xl text-sm leading-7 text-slate-600">
                Easily grab this text to drop into an email, LinkedIn, or text message.
              </p>
...
function StepCard({
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <div className="flex items-center gap-3">
        <div className="inline-flex h-10 min-w-10 items-center justify-center rounded-full bg-orange-50 px-3 text-sm font-semibold text-orange-700">
          {n}
          {label && accentLabel ? <span className="ml-2 whitespace-nowrap text-[10px] uppercase tracking-[0.12em] text-orange-700">{label}</span> : null}
        </div>
      </div>
