...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const ogImageUrl = `${BOOKING_REDIRECT_PATH}/opengraph-image`;
  ...
  return {
    ...
    alternates: {
      canonical: BOOKING_REDIRECT_PATH,
    },
    openGraph: {
      title: BOOKING_PAGE_TITLE,
      description: BOOKING_PAGE_DESCRIPTION,
      url: BOOKING_REDIRECT_PATH,
      type: "website",
      siteName: "Glyph Labs",
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Cam Lillico BOS360 intro call",
        },
      ],
    },
    twitter: {
...
export default function BookPage() {
  const targetUrl = getBookingTargetUrl();
