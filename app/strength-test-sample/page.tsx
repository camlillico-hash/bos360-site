...
export const metadata = {
  ...
  icons: {
    icon: "/strength-test-sample/icon.png",
    shortcut: "/strength-test-sample/icon.png",
    apple: "/strength-test-sample/icon.png",
  },
};
        ...
        <div className="mt-8 rounded-2xl border border-slate-800 bg-slate-900/60 p-6">
          <div className="grid gap-6 md:grid-cols-[340px_1fr] md:items-start">
            ...
            <div>
              ...
              <span className="download-results-btn mt-3 inline-flex items-center gap-1.5 rounded border border-slate-600 px-3 py-1.5 text-sm font-semibold text-slate-200">
